...
- the entry point for progress, logs, documents, architecture and calendar
...
You must always preserve the following boundaries:
...
The portal belongs to the same family as our other project pages, but it must be **more serious and more portal-like** than the recruitment page.
...
The home page must **not** duplicate full-detail content from logs, docs, architecture or calendar pages.
...
If something is already fully explained in `/logs`, `/docs`, `/architecture`, `/calendar`, or `/team`, the home page should only summarize it and link out.
...
But dynamic content is maintained with **English as the default source language**.
...
## Files You Should Read Before Big Changes

- `README.md`
- `docs/design-system-revision.md`
- `docs/content-authoring-guide.md`
- `docs/component-semantics.md`
- `docs/mock-data-policy.md`

## Related Repositories / Links

These should usually be centralized in config, not scattered in components.
...
- `project-portal`
- `m2-recruitment-site`
- team links / friend links to collaborator groups
